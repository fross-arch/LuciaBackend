...
public class Person {
    ...
    public Person createPerson(Person person)    { return person; }

    public Person updatePerson(Person person)    { return person; }

    public List<Person> getAllPersons()          { return null; }

    public Person getPersonById(int id)          { return null; }
